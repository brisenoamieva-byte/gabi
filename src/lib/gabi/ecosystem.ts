...
export const GABI_ECOSYSTEM: GabiModulo[] = [
  {
    ...
    linea: "plataforma",
    titulo: "Centro gabi",
    descripcion: "Vista integral del cerebro inmobiliario: propuestas, estudios y operación.",
    href: "/gabi",
  ...
  },
  {
    ...
    descripcion:
      "Paquetes B2B para desarrolladores: escenario financiero, estrategia, equipo y condiciones de exclusiva.",
    href: "/propuestas",
    visibilidad: "operador",
    exportable: true,
    compartible: true,
  },
  {
    ...
    descripcion:
      "Análisis privados (metraje, competencia, demanda). Exportables o vendibles a desarrolladores.",
    href: "/estudios",
    visibilidad: "operador",
    exportable: true,
  },
  {
    id: "corredor",
    linea: "inmobiliaria",
    titulo: "gabi Real Estate · Corredor sur",
    descripcion:
      "Zona sur Querétaro: mapa, comparativo y acuerdos de comercialización de terrenos con desarrolladores.",
    href: "/corredor",
