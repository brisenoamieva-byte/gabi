    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(32,16,68,0.08);">
        <tr><td style="background:#13315C;padding:28px 32px;">
          <p style="margin:0;font-size:11px;font-weight:700;letter-spacing:0.2em;text-transform:uppercase;color:#2DD4BF;">gabi</p>
          <h1 style="margin:8px 0 0;font-size:22px;font-weight:800;color:#ffffff;line-height:1.3;">Gracias por tu visita</h1>
        </td></tr>
        ...
        <tr><td style="padding:20px 32px;background:#F8FAFC;border-top:1px solid #E2E8F0;">
          <p style="margin:0;font-size:12px;color:#94A3B8;text-align:center;">Enviado con <a href="${siteUrl}" style="color:#13315C;font-weight:600;text-decoration:none;">gabi</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
