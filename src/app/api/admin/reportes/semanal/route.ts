...
import { getReporteComercialSemanal } from "@/lib/admin/reporte-semanal/service";
...
export async function GET(request: Request) {
  ...
  try {
    const reporte = await getReporteComercialSemanal({ desarrolloId, desde, hasta }, session.profile);
