...
export default function DashboardPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#f7f5fb] text-[#1e293b]">
      ...
      <section className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-4 px-5 py-6 md:px-10 md:py-8">
        ...
        >
          {desarrollo.logo ? (
            <div className="flex h-11 w-14 shrink-0 items-center justify-center rounded-xl bg-[#faf8f4] p-1.5">
              <Image
                src={desarrollo.logo}
                alt=""
                width={120}
