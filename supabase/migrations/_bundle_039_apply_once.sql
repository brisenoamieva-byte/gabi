-- Pegar en Supabase SQL Editor si no tienes SUPABASE_DB_URL local.
-- Migración 039: calendario de guardias (matutino / vespertino).
...
drop policy if exists "guardia_asignaciones_service_all" on public.guardia_asignaciones;
