-- gabi · Motor de cadencia de perfilamiento BBR (8 días, toques programados)
...
comment on table public.prospecto_cadencia is
  'Secuencia de perfilamiento activa por prospecto (etapa Nuevo).';
...
comment on table public.prospecto_cadencia_touches is
  'Toques programados de la secuencia BBR (WhatsApp / llamada por día).';
