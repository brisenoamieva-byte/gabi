-- gabi · Notificaciones WhatsApp de leads + carrusel por guardia del día
...
comment on column public.campanas.meta_lead_form_id is
  'ID del formulario Meta Lead Ads vinculado a esta campaña.';
...
comment on table public.lead_carousel_state is
  'Índice de carrusel diario para asignar leads entre asesores en guardia publicada.';
